...
// 得到所有女生
// const arr=students.filter(i=>{
//   return i.sex==='女'
// })

// 得到所有年龄在25岁以下的女生、
// const arr=students.filter(i=>{
//   return i.sex==='女'&&i.age<=25
// })

// 得到所有姓陈的学生
// const arr=students.filter(i=>{
//   return i.name.startsWith('冯')
// })
...
//   });
// console.log(names);
// const names=students.filter(item=>item.sex ==='女').map(i=>i.name)
// console.log(names);
// 得到所有女生的姓名和电话号码 [ {name:'monica', tel:'18122223333'} ]
// const names=students.filter(item=>item.sex ==='女').map(i=>({name:i.name, tel:i.tel}))
// console.log(names);
...
// console.log(sum,'撒大声地')
// 找到id为796997的学生对象
// const stu = students.find(i=>{i.id===796997})


// 是否包含年龄大于28岁的男生

// const stu =students.some(i=>{
//   return i.age>28
// })
// console.log(stu,'2')
//  是否所有的女生年龄都在28岁以内
